...
class ControllerCatalogReview extends Controller {
	...
	public function index() {
        ...
        $this->model_catalog_review->install();
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            if (isset($this->request->post['hidden_customer_info'])) {
                $this->model_catalog_review->addReviewAddictionInfo($review_id, 1);
            } else {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			foreach ($this->request->post['selected'] as $review_id) {
				...
				$this->model_catalog_review->deleteReviewAddictionInfo($review_id);
				$this->model_catalog_review->deleteReviewImages($review_id);
			}
	...
	protected function getForm() {
        ...
        if (isset($this->request->post['hidden_customer_info'])) {
            $data['hidden_customer_info'] = $this->request->post['hidden_customer_info'];
        } elseif (!empty($review_addiction_info)) {
            $data['hidden_customer_info'] = $review_addiction_info['hidden_customer_info'];
        } else {
            $data['hidden_customer_info'] = '';
        }
	...
	public function deleteReviewImage() {
        if(isset($this->request->get['image_id']) && $this->request->server['REQUEST_METHOD'] == 'POST') {
            ...
            $this->model_catalog_review->deleteReviewImage($this->request->get['image_id']);
        }
    }
